...
table.dataTable td {
  white-space: nowrap;
    ...
    <x-slot name='title'>BDM commision criteria</x-slot>
    <div class="content-wrapper" style="min-height: 1518.06px;">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">BDM commission criteria</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                     <table class="table  table-bordered table-hover table-responsive" id="bdmComissionCriteria" cellspacing="0" width="100%">
                        <thead>
                            <tr>
     ...
     <form action="{{route('admin.bdm-commission-criteria.create')}}" method="post" enctype="multipart/form-data">
               @csrf
   ...
   <div class="modal fade" id="editBdmCommissionModel" tabindex="-1" role="dialog" aria-labelledby="editBdmCommissionModel" aria-hidden="true">
     <form action="{{route('admin.bdm-commission-criteria.update')}}" method="post" enctype="multipart/form-data">
               @csrf
         <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
               <div class="modal-header">
